...
public abstract class CMsgWriter {
  ...
  public synchronized void writeFramebufferUpdateRequest(Rect r,
                                                         boolean incremental)
  {
	System.out.println("wrote frame buffer update");
  ...
  {
	// Uncomment these comments to calculate keypress time for input latency test and keypress process time
...
//    System.out.println((end-start) + "keypress time");
  }
